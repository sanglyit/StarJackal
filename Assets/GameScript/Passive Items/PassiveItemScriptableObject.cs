...
public class PassiveItemScriptableObject : ScriptableObject
{
    ...
    [SerializeField] GameObject nextLevelPrefab; //the prefab of the next level = what the object becomes when it levels up. Not to be confused with the prefab to be spawned at the next level.
